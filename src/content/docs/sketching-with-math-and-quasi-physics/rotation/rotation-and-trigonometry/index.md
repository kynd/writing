...
slug: rotation-and-trigonometry
---
# Trigonometry
# 三角関数
...
$$\sin A = \cfrac{\text{opposite}}{\text{hypotenuse}}, \quad \cos A = \cfrac{\text{adjacent}}{\text{hypotenuse}}$$

Tangent is the ratio of opposite and adjacent sides.

タンジェント、tanは対辺と隣辺の比です。

$$\tan A = \cfrac{\text{opposite}}{\text{adjacent}} = \cfrac{y}{x}$$
...
[![](/images/rotation-and-trigonometry-3.jpg "75")](/images/rotation-and-trigonometry-3.jpg)
...
If you want to rotate an object around an arbitrary axis, not just around the x, y, and z axes, you can use [Rodrigues' rotation formula](https://en.wikipedia.org/wiki/Rodrigues%27_rotation_formula). To rotate a vector, or a point $\mathbf{p}$, around an axis represented by a [normalized](/vector-operations) vector $\mathbf{n}$, you can calculate the point after the rotation, $\mathbf{p}’$, as follows.
...
This is an example of the Rodrigues' rotation formula in use in GLSL. You can find more examples on the [Designing 3D world](/designing-3d-world) page.

これはロドリゲスの回転公式をGLSLで使った例です。[3Dのデザイン](/designing-3d-world)のページにはより多くの例があります。
