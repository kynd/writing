...
$$\zeta(s) = \sum_{n=1}^{\infty} \dfrac{1}{n^s} = 1 + \dfrac{1}{2^s} + \dfrac{1}{3^s} + \dots \quad \text{for } s > 1$$
...
$$\zeta(s) = \prod_{p \text{ prime}} \dfrac{1}{1 - p^{-s}} = \left(\dfrac{1}{1-2^{-s}}\right) \cdot \left(\dfrac{1}{1-3^{-s}}\right) \cdot \left(\dfrac{1}{1-5^{-s}}\right) \dots \quad \text{for } s > 1$$
...
$$\eta(s) = \sum_{n=1}^{\infty} \dfrac{(-1)^{n-1}}{n^s} = 1 - \dfrac{1}{2^s} + \dfrac{1}{3^s} - \dfrac{1}{4^s} + \dots$$

$$\zeta(s) = \dfrac{1}{1 - 2^{1-s}} \eta(s)$$
