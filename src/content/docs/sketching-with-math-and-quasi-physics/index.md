...
- [Many intros for Sketching with Code](/sketching-with-math-and-quasi-physics/many-intros-for-sketching-with-code)
...
- [Distance 距離](/sketching-with-math-and-quasi-physics/distance)
...
- [Rotation 回転](/sketching-with-math-and-quasi-physics/rotation)
...
- [Image Processing 画像処理](/sketching-with-math-and-quasi-physics/image-processing)
...
- [Calculus for Makers 作るための微積分](/sketching-with-math-and-quasi-physics/calculus-for-makers)
...
- [Patterns パターン](/sketching-with-math-and-quasi-physics/patterns)
...
- [Curves 曲線](/sketching-with-math-and-quasi-physics/curves)
...
- [Reading "Attention Is All You Need"](/sketching-with-math-and-quasi-physics/reading)
  - [Abstract, Introduction and Background 概要、序論と背景](/sketching-with-math-and-quasi-physics/reading/abstract-introduction-and-background)
  - [Architecture Overview アーキテクチャの概要](/sketching-with-math-and-quasi-physics/reading/architecture-overview)
  - [Attention Mechanism アテンション機構](/sketching-with-math-and-quasi-physics/reading/attention-mechanism)
...
- [Math Snippets](/sketching-with-math-and-quasi-physics/math-snippets)
...
- [Pencils, Brushes and Paints 鉛筆、筆、絵の具](/sketching-with-math-and-quasi-physics/pencils-brushes-and-paints)
